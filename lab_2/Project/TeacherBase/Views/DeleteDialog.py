...
class DeleteDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        # Создаем вкладки для разных условий удаления
        tab_widget = QTabWidget()

        # Вкладка 1: Удаление по фамилии и кафедре
        tab1 = QWidget()
        ...
        # Вкладка 2: Удаление по ученому званию и факультету
        tab2 = QWidget()
        ...
        # Вкладка 3: Удаление по стажу работы
        tab3 = QWidget()
